...
-- CreateEnum
CREATE TYPE "CartStatus" AS ENUM ('PENDING', 'CHECKED_OUT', 'ABANDONED');
...
CREATE TABLE "SystemSettings" (
    ...
    "name" TEXT NOT NULL DEFAULT 'QRBS',
    "address" TEXT NOT NULL DEFAULT '123052/Street, City',
    "phoneNumber" TEXT NOT NULL DEFAULT '944858585858',
    "updatedAt" TIMESTAMP(3) NOT NULL,
